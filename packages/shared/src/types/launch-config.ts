...
export const ServiceConfigSchema = z.object({
    ...
    envKey: z.string().optional().describe("Environment variable key for the port (e.g. 'PORT')"),
    ...
    argument: z
        .string()
        .optional()
        .describe("CLI argument flag to override port (e.g. '--port', '--api-port')"),
    ui: z.boolean().default(false).describe("Whether this service has a UI to open"),
}).transform((data) => {
