      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        >
          <CardHeader class="pb-2">
            ...
            <CardTitle class="text-2xl">{{ servers.claudeDesktop.length }}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        >
          <CardHeader class="pb-2">
            ...
            <CardTitle class="text-2xl">{{ servers.claudeCode.length }}</CardTitle>
          </CardHeader>
          <CardContent>
            <p class="text-xs text-muted-foreground font-mono">
        ...
        <CardContent>
          ...
          <ScrollArea v-else class="max-h-[500px]">
            <Table>
              ...
              <TableBody>
                <TableRow v-for="server in filteredServers" :key="`${server.source}-${server.name}`">
